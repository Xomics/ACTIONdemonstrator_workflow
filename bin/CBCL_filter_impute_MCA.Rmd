---
title: "Preparation of CBCL behavioral data for downstream analysis"
output: html_document
params:
    cbcl_infile: "../test_files/cbcl_simulated.csv"
...
```{r}
require(factoextra)
print(head(get_eigenvalue(mca_pheno), n = 10))
...
```{r}
fviz_contrib(mca_pheno, choice = "var", axes = 1, top = 20)
fviz_contrib(mca_pheno, choice = "var", axes = 2, top = 20)
fviz_contrib(mca_pheno, choice = "var", axes = 3, top = 20)
```

Association of variable categories with dimensions.

```{r}
fviz_cos2(mca_pheno, choice = "var", axes = 1:2, top = 20)
```

Contribution of individuals to dimensions

```{r}
fviz_contrib(mca_pheno, choice = "ind", axes = 1, top = 10)
```

MCA dimension description

```{r}
dimdesc_mca_rfimp <- dimdesc(mca_pheno, axes = 1)
```
