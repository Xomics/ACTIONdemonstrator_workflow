...
process MOFA_ANALYSIS_WITH_GEE {
	...
	"""
	cp -L $project_dir/bin/MOFA_downstream_analysis_report.Rmd MOFA_downstream_analysis_report_gee.Rmd
	Rscript -e "rmarkdown::render('MOFA_downstream_analysis_report_gee.Rmd', output_format = 'html_document', output_file = 'mofa_analysis.html',  params = list(modelFile = '${mofa_model}', metaData = '${pheno_covariates}', mcaCoord = '${cbcl_mca_dimensions}', epic_anno = '${epic_anno}'  ))"
	"""
